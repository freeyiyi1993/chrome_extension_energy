...
└── components/                #   UI 组件测试 (30 case)
    ├── MainDashboard.test.tsx  #     打卡流程+庆祝弹窗 (16 case)
...
- [x] 测试覆盖 23→139 case (逻辑/同步/时间/类型/ticker/pomoSubmit/Puppeteer UI/组件)
...
- [x] UI 组件测试 30 case (MainDashboard/PomodoroRing/SettingsPage/BaseAuthPanel)
